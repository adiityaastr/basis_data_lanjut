...
-- File: COMPLETE_UAS_SQL.sql
-- Deskripsi: File SQL lengkap yang mencakup seluruh soal UAS
-- 
-- Isi file ini:
-- 1. CREATE DATABASE dan struktur tabel (customers, orders, activity_logs)
-- 2. INSERT data sample (50 customers, 1000 orders)
-- 3. CREATE TRIGGERS untuk logging CRUD operations
-- 4. TEST QUERIES sesuai spesifikasi soal (5 query)
--
-- Cara penggunaan:
--   mysql -u root -p < COMPLETE_UAS_SQL.sql
-- =============================================
...
-- 2. ✅ Insert Data (50 customers, 1000 orders)
